  ...
  return (
    <section className='container mx-auto flex flex-col px-5 py-5 lg:flex-row '>
          ...
          <div className='mt-10 lg:w-1/2'>
               <h1 className='font-roboto text-3xl md:text-5xl lg:text-4xl xl:text-5xl text-center font-bold text-dark-soft lg:text-left lg:max-w-[540px]'>Read the most interesting articles</h1>
            ...
            <div className='flex flex-col gap-y-2.5 mt-10 lg:mt-6 xl:mt-10 relative'>
                <div className='relative'>
                   ...
                   <input type="text" 
                           className='placeholder:font-bold font-semibold text-dark-soft placeholder:text-[#959EAD] rounded-lg pl-12 py-3 pr-3 w-full focus:outline-none shadow-[rgba(13,_38,_76,_0.19)_0px_9px_20px] md:py-4' 
             ...
             <span className='text-dark-light font-semibold italic mt-2 lg:mt-4 lg:text-sm xl:text-base'>Populer Tags : </span>
             <ul className='flex flex-wrap gap-x-2.5 gap-y-2.5 mt-3 lg:text-sm xl:text-base'>
               <li className='rounded-lg bg-primary bg-opacity-10 px-3 py-1.5 text-primary font-semibold'>Desing</li>
